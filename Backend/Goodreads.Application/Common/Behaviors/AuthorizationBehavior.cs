...
public class AuthorizationBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
{
    ...
    public AuthorizationBehavior(
        IAuthorAuthorizationService authorizationService, 
        IShelfAuthorizationService shelfAuthService, 
        IUnitOfWork unitOfWork, 
        IQuoteAuthorizationService quoteAuthService, 
        IReviewAuthorizationService reviewAuthService)
    {
